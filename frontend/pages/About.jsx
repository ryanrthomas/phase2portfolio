...
const About = () => {
  ...
  return (
    <section className="mt-4">
      <h2 className="text-2xl font-normal mb-2">About Me</h2>
      ...
      <div className="flex justify-between items-end gap-2 mb-4">
        {games.map((game, index) => (
          <div key={index} className="flex flex-col items-center">
            ...
            <p className="text-md text-center leading-tight">{game.name}</p>
          </div>
        ))}
      </div>
      ...
      <div className="space-y-3">
        <div>
          <h3 className="text-xl font-normal underline">Skills</h3>
